...
typedef OnStartListener = void Function(MicroService service);
typedef void OnErrorListener(MicroService service, error);
typedef OnExitListener = void Function(MicroService service, int exitCode);
...
class MicroService {
  ...
  static final _instances = <String, MicroService>{};
